...
| [bindCustomElement](#dom_bindcustomelement) | Function | This function simplified the registering of Custom Element and creating a DomBind. |
...
| NumStr      | The NumStr function returns a TypeGuard that checks for a string value that represents a number, and takes optional min and max (inclusive) values to range check. |
