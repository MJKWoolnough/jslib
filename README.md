...
|  Export  |  Type  |  Description  |
|----------|--------|---------------|
| addNodeRef | Function | An function that extends a class with a [node] field set to `this`. Can be used with the [elements](#elements) library as an extender function. |
