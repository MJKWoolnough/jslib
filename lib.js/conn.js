 ...
 * @property {string} [method]   Can change the request method.
 * @property {string} [user]     Allows the setting of a Basic Authorization username.
 * @property {string} [password] Allows the settings of a Basic Authorization password.
 ...
 * @property {(data: unknown) => boolean} [checker]                This function is used to check whether parsed JSON matches the expected data structure. It is recommended to use a checker function when receiving data, and the {@link module:typeguard | TypeGuard} module can aid with that.
 ...
 * @property {AbortSignal} [signal]                                An {@link https://developer.mozilla.org/en-US/docs/Web/API/AbortSignal | AbortSignal} to be used to cancel any request.
 */
 ...
 */
WS = (url, protocols) => new Promise((successFn, errorFn) => {
