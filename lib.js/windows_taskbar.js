...
export class ShellElement extends BaseShellElement {
	constructor() {
		...
		createHTML(this.attachShadow({"mode": "closed"}), [
			style({"type": "text/css"}, `:host{display:block;position:relative;overflow:hidden;width:var(--shell-width,100%);height:var(--shell-height,100%)}::slotted(windows-window:last-of-type){--overlay-on:none}:host>ul{list-style:none;padding:0;position:absolute;bottom:0;left:0;width:100%;height:4em;margin:0;overflow-y:hidden;overflow-x:auto;background-color:#eee;white-space:nowrap;user-select:none;border-style:solid;border-color:#000;border-width:1px 0 0 0}:host([side="top"])>ul{top:0;bottom:unset;border-width:0 0 1px 0}:host([side="left"])>ul{top:0;width:4em;border-width:0 1px 0 0}:host([side="right"])>ul{top:0;left:unset;right:0;width:4em;border-width:0 0 0 1px}:host ::slotted(windows-desktop){padding-bottom:4em}:host([side="top"]) ::slotted(windows-desktop){padding-top:4em;padding-bottom:0}:host([side="left"]) ::slotted(windows-desktop){padding-left:4em;padding-bottom:0}:host([side="right"]) ::slotted(windows-desktop){padding-right:4em;padding-bottom:0}:host>ul li{border:1px solid #000;display:inline-block;padding:0;margin:0;overflow:hidden}:host([side="left"])>ul,:host([side="right"])>ul{overflow-y:auto;overflow-x:hidden;height:100%;white-space:unset}:host([side="left"])>ul>li,:host([side="right"])>ul>li{display:list-item}:host>ul img{height:4em}:host>ul span{display:inline-block;height:4em;vertical-align:middle}:host([hide="icon"])>ul img,:host([hide="title"])>ul span{display:none}:host([autohide][side="left"])>ul:not(:hover){width:1px;height:100%;border-width:0 5px 0 0}:host([autohide][side="right"])>ul:not(:hover){width:1px;height:100%;border-width:0 0 0 5px}:host([autohide])>ul:not(:hover){height:1px;border-width:5px 0 0 0}:host([autohide][side="top"])>ul:not(:hover){border-width:0 0 5px 0}:host([autohide])>ul:not(:hover)>*{display:none}`),
			slot({"name": "desktop"}),
			taskbar,
