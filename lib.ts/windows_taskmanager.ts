...
import {amendNode, bindCustomElement, clearNode, event, eventOnce} from './dom.js';
import {div, footer, slot} from './html.js';
 ...
 */
shell = bindCustomElement("windows-shell-taskmanager", ShellElement);
