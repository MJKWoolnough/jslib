...
bindCustomElement = <T extends HTMLElement>(name: string, constructor: {new (...params: any[]): T}, options?: ElementDefinitionOptions | undefined) => {
	...
	return Object.defineProperties((props?: Props | Children, children?: Children) => amendNode(new constructor(), props, children), {"name": {"value": name}, [child]: {"get": () => document.createElement(name) as T}}) as DOMBind<T>;
},
/**
