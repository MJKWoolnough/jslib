 ...
 */
export const setDragEffect = (effects: Partial<Record<Effect, (DragTransfer | DragFiles)[]>>): ((e: DragEvent) => boolean) => (e: DragEvent) => {
	if (e.dataTransfer) {
