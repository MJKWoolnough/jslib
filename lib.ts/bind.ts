...
/**
 * This module contains a Function for creating DOM nodes (such as {@link https://developer.mozilla.org/en-US/docs/Web/API/Attr | Attr} and {@link https://developer.mozilla.org/en-US/docs/Web/API/Text | Text} nodes) that update their content automatically.
 *
