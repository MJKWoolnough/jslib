...
export class Binding<T = string> extends Callable<(v: T) => T> implements BoundAttr, BoundChild {
	 ...
	 * @param {Function}   fn The node generating function, which takes different values depending on the bound type.
	 *
	...
	toDOM<N extends ParentNode>(n: N, fn: (v: T extends Array<unknown> ? never : T extends Map<unknown, unknown> ? never :T) => (Node | null)): N;
