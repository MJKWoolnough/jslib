		...
		"languages": Object.entries({
			...
			"bash": {
				...
				"arithmetic expansion": {
					...
					"output": `<span class="punctuator">$((</span><span class="whitespace">&nbsp;</span><span class="numericliteral">1</span><span class="whitespace">&nbsp;</span><span class="punctuator">+</span><span class="whitespace">&nbsp;</span><span class="numericliteral">1</span><span class="whitespace">&nbsp;</span><span class="punctuator">))</span><span class="whitespace">&nbsp;</span><span class="punctuator">$((</span><span class="whitespace">&nbsp;</span><span class="keyword">a--</span><span class="whitespace">&nbsp;</span><span class="punctuator">))</span><span class="whitespace">&nbsp;</span><span class="punctuator">$((</span><span class="whitespace">&nbsp;</span><span class="numericliteral">1</span><span class="whitespace">&nbsp;</span><span class="punctuator">+</span><span class="whitespace">&nbsp;</span><span class="punctuator">((</span><span class="whitespace">&nbsp;</span><span class="numericliteral">2</span><span class="whitespace">&nbsp;</span><span class="punctuator">*</span><span class="whitespace">&nbsp;</span><span class="identifier">$b</span><span class="whitespace">&nbsp;</span><span class="punctuator">))</span><span class="whitespace">&nbsp;</span><span class="punctuator">+</span><span class="whitespace">&nbsp;</span><span class="stringliteral">"4"</span><span class="whitespace">&nbsp;</span><span class="punctuator">))</span>`
				},
				"brace expansion": {
