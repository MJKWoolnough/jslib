	...
	"markdown_code": {
		...
		"languages": Object.entries({
			...
			"bash": {
				...
				"let": {
					"source": "let a=1\nlet a=(1);let a=( 1 )\nlet a=1+2 b=2*3",
					"output": `<span class="futurereservedword">let</span><span class="whitespace">&nbsp;</span><span class="identifier">a</span><span class="punctuator">=</span><span class="numericliteral">1</span><span class="lineterminator"><br></span><span class="futurereservedword">let</span><span class="whitespace">&nbsp;</span><span class="identifier">a</span><span class="punctuator">=(</span><span class="numericliteral">1</span><span class="punctuator">);</span><span class="futurereservedword">let</span><span class="whitespace">&nbsp;</span><span class="identifier">a</span><span class="punctuator">=(</span><span class="whitespace">&nbsp;</span><span class="numericliteral">1</span><span class="whitespace">&nbsp;</span><span class="punctuator">)</span><span class="lineterminator"><br></span><span class="futurereservedword">let</span><span class="whitespace">&nbsp;</span><span class="identifier">a</span><span class="punctuator">=</span><span class="numericliteral">1</span><span class="punctuator">+</span><span class="numericliteral">2</span><span class="whitespace">&nbsp;</span><span class="identifier">b</span><span class="punctuator">=</span><span class="numericliteral">2</span><span class="punctuator">*</span><span class="numericliteral">3</span>`
				},
				"redirections": {
